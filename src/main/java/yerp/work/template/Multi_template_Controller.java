...
public class Multi_template_Controller {
	...
	public ResponseEntity<JSONObject> multi_template_01_F0(@CommonParam Map<String, Object> parameter) {
		...
		try {
			String sqlMap = "template.multi_template_01_F0";
            ...
            for(Object outerArray : param) {
                ...
                sqlResult.add({"dlt_01" : commonService.selectList(sqlMap, parameter)});
                sqlResult.add(i ,commonService.selectList(sqlMap, parameter));
            }
