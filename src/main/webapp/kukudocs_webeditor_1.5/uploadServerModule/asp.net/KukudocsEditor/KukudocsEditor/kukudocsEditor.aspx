<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kukudocsEditor.aspx.cs" Inherits="KukudocsEditor.WebForm1" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="App_Data/KukudocsEditor_Version1/externalLib/jquery-1.9.1.min.js"></script>
    <script type="text/javascript" src="App_Data/KukudocsEditor_Version1/externalLib/jquery-ui-1.11.4.min.js"></script>
    <script type="text/javascript" src="App_Data/KukudocsEditor_Version1/javascripts/build/Editor.bundle.js"></script>
    <script type="text/javascript" src="App_Data/KukudocsEditor_Version1/javascripts/build/OperationSetting.bundle.js"></script>

    <link rel="stylesheet" href="App_Data/KukudocsEditor_Version1/stylesheets/style.css"/>
    <style>
        body {
            height: 100%;
            margin: 0;
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            window.kukuEditor = new KuKudocsEditor('editor', {
                ...
                hiddenMenu: ['new', 'save', 'print'],
                publicPathURL: './App_Data/KukudocsEditor_Version1/',
                fileUploadURL : '/ImageUpload.ashx',
